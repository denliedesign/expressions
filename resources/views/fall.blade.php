...
{{--            </div>--}}
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
                <a href="/images/23-program.pdf" target="_blank">
                    <img src="/images/23-program_page-0001.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
                <a href="/images/23-program.pdf" target="_blank">
                    <img src="/images/23-program_page-0002.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
                <a href="/images/23-program.pdf" target="_blank">
                    <img src="/images/23-program_page-0003.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
            </div>
            <div class="d-flex justify-content-center my-4">
                <div class="btn btn-primary btn-lg shadow">

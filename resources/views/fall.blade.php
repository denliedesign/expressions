...
{{--            </div>--}}
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
                <img src="/images/24-25-class-guide-c_page-0001.jpg" alt="fall class guide" class="img-fluid">
                <img src="/images/24-25-class-guide-c_page-0002.jpg" alt="fall class guide" class="img-fluid">

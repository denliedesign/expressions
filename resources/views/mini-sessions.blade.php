    ...
    <div class="py-5">
        <div class="container my-md-5 py-md-5">
            ...
            <div class="d-flex justify-content-center">
                <img src="/images/broadway-babies-2.png" alt="baby in broadway outfit" class="img-fluid my-3 rounded" style="max-width: 525px; width: 100%; height: auto;">
            </div>
            ...
            <p class="mt-3 text-center">
                ...
                <br><br>
                During the last week of class, November 11, you are welcome to invite a guest to observe the class.
            </p>

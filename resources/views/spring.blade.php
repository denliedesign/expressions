    ...
    <div class="my-5">
        <div class="container my-md-5 py-md-5">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
                <a href="/images/23-24-program.pdf" target="_blank">
                    <img src="/images/23-24-program.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
                <a href="/images/23-24-program.pdf" target="_blank">
                    <img src="/images/23-24-program-2.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
                <a href="/images/23-24-program.pdf" target="_blank">
                    <img src="/images/23-24-program-3.jpg" alt="fall flyer" class="img-fluid rounded">
                </a>
            </div>
            <div class="d-flex justify-content-center my-4">
                <div class="btn btn-primary btn-lg shadow">

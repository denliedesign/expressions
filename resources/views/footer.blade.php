<div id="footer" class="mt-4">
    <div style="width: 100%; background: #2A42C8; position: relative;" class="my-0 py-0">
        @include('waves-top')
        <div class="container">
            <div class="row my-0 py-5 text-white d-flex align-items-end">
                <div class="col d-flex justify-content-center">
                    <div>
                        <img src="/images/edt-logo.png" alt="edt logo" class="img-fluid mb-2" style="height: 100px; width: auto;">
                        <br>Copyright © 2021
                        <br>Expressions Dance Theatre
                        <br><a href="https://www.denliedesign.com" class="text-white" style="text-decoration: none;">Dance Studio Websites</a>
                    </div>
                </div>
                <div class="col d-flex justify-content-center">
                    <div>
                    ...
                    <div class="row">
                        <div class="col">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item py-0 my-0">
                                    <a class="nav-link text-white py-0 my-0" href="/meet-our-faculty">Meet Our Faculty</a>
                                </li>
                                <li class="nav-item py-0 my-0">
                                    <a class="nav-link text-white py-0 my-0" href="certifications-and-recognition">Certifications & Recognition</a>
                                </li>
                                <li class="nav-item py-0 my-0">
                                    <a class="nav-link text-white py-0 my-0" href="/testimonials">Testimonials</a>
                                </li>
                                <li class="nav-item py-0 my-0">
                                    <a class="nav-link text-white py-0 my-0" href="/recreational">Recreational</a>
                                </li>
                                <li class="nav-item py-0 my-0">
                        ...
                        <div class="col">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item py-0 my-0">
                                    <a class="nav-link text-white py-0 my-0" href="https://edtfamily.teamapp.com" target="_blank">Calendar</a>
                                </li>
                                <li class="nav-item py-0 my-0">
